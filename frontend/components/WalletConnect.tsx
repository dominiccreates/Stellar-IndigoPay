...
export default function WalletConnect({ onConnect }: WalletConnectProps) {
  ...
  return (
    <div className="card max-w-sm mx-auto text-center animate-slide-up shadow-indigo">
      ...
      <h3 className="font-display text-xl font-semibold text-[#0F172A] dark:text-[#E2E8F0] mb-2">Connect Your Wallet</h3>
      <p className="text-[#475569] dark:text-[#94A3B8] text-sm mb-5 font-body leading-relaxed">
        Use <a href="https://freighter.app" target="_blank" rel="noopener noreferrer" className="text-[#4F46E5] dark:text-[#818CF8] hover:underline font-semibold">Freighter</a> to donate XLM directly to climate projects with zero platform fees.
      </p>
      {error && <div className="mb-4 p-3 rounded-xl bg-[rgba(244,63,94,0.08)] border border-[rgba(244,63,94,0.15)] text-[#E11D48] dark:text-[#FB7185] text-sm font-body">{error}</div>}
      ...
      <p className="mt-3 text-xs text-[#64748B] dark:text-[#94A3B8] font-body">
        No wallet? <a href="https://freighter.app" target="_blank" rel="noopener noreferrer" className="text-[#4F46E5] dark:text-[#818CF8] hover:underline font-medium">Install Freighter →</a>
      </p>
    </div>
  );
}
